const sampleForm = document.getElementsByClassName("form")[0];
const submitButtopn = document.getElementsByClassName("submit_button")[0];
const buttonop = document.getElementsByClassName("thanks")[0];
...
sampleForm.addEventListener("submit", async (e) => {
  ...
  try {
    ...
    submitButtopn.setAttribute("disabled", "disabled");
    buttonop.style.opacity = '1';
  } catch (error) {
